...
function bringmain() {
    ...
    document.getElementById('usernamebar').innerHTML = "Barua Prayer Assembly";
...
function openfaq() {
    swal({
        title: "Barua Prayer Assembly",
        text: 'Send your prayers here and they will be pushed to Barua\'s registers.',
        html: true,
...
var opennewpost = function () {
    swal({
            ...
            animation: "slide-from-bottom",
            "confirmButtonColor": "#00563a",
            inputPlaceholder: "Ask and you shall receive..."
        },
        function (inputValue) {
            if(inputValue==null){
            ...
            var request = getRequest()
            var bitt = {
                "username": "Anonymous Assembler",
                "bittcontent": inputValue,
                "bittheader": "added-to-registers"
            }
